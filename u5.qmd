...
2. *Digital environments*, specifically the tools and online spaces we use to interact with each other. (For example Facebook, Discourse, X, Blogs, Forums etc.).
3. *Interactions* between these identities and environments.

::: {#fig-DigitalxcitizenshipxVenn}

![](assets/u5/Digital_citizenship_Venn.png){fig-alt="The model for digital citizenship from the work of Autumm Cainnes" .lightbox fig-align="left"}

The model for digital citizenship from the work of Autumm Cainnes
...
Watch the video, [Watch: *Communities of Practice (Etienne and Beverly Wenger-Trayner)*](https://www.youtube.com/watch?v=SmqLyOLIjos){target="_blank"} <!-- Auto title, auto embed--> 
...
![](assets/u5/social_map.png){fig-alt="" .lightbox fig-align="left"}

> *[Image](https://flickr.com/photos/briansolis/2374839848){target="_blank"} by [Brian Solis](https://flickr.com/photos/briansolis/){target="_blank"} shared under a [Creative Commons (BY) license](https://creativecommons.org/licenses/by/2.0/){target="_blank"}*
...
#### Collaboration & Annotation Tools {.unnumbered}
...
Next, watch [Watch: *How to Annotate the Web with hypothes.is*](https://www.youtube.com/watch?v=e235JwmmEcQ){target="_blank"} <!-- Auto title, auto embed--> 
...
1. Read the following article: [Knowing the Difference Between Digital Skills and Digital Literacies, and Teaching Both](https://www.literacyworldwide.org/blog/literacy-now/2016/02/03/knowing-the-difference-between-digital-skills-and-digital-literacies-and-teaching-both){target="_blank"}.
...
2. **Watch** [*Building More Creative Social Networks*](https://www.youtube.com/watch?v=Acc4zY1sQ0o){target="_blank"} <!-- Auto title, auto embed--> 

{{< video https://www.youtube-nocookie.com/embed/Acc4zY1sQ0o >}}


3. **Explore**: [The Conversation Prism](https://www.briansolis.com/2008/08/introducing-conversation-prism-html/){target="_blank"} developed by [Brian Solis](https://www.briansolis.com/about/){target="_blank"}.
...
<a title="Conversation Prism 4" href="https://flickr.com/photos/solucionafacil/11327713066" target="_blank">

::: {#fig-11327713066xc661527cef}

![](assets/u5/conversation_prism.jpg){fig-alt="" .lightbox fig-align="left"}

[Image](https://flickr.com/photos/solucionafacil/11327713066){target="_blank"} by [SolucionaFacil.es](https://flickr.com/people/solucionafacil){target="_blank"} shared under a [Creative Commons (BY-ND) license](https://creativecommons.org/licenses/by-nd/2.0/){target="_blank"}
...
{{< video https://vimeo.com/584977176/f1938444cb >}}
...
#### Part 1: Written Reflection {.unnumbered}
...
To help you structure your writing, see the following video on [Watch: *Reflective writing*](https://www.youtube.com/watch?v=SntBj0FIApw){target="_blank"} <!-- Auto title, auto embed--> 

{{< video https://www.youtube-nocookie.com/embed/SntBj0FIApw >}}
...
#### Part 2: Video Reflection {.unnumbered}
