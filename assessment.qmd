...
### Part 1: Learning Journal {.unnumbered}
...
Prote: The below table is hidden from the course.

#### Proficiency Levels {.unnumbered}
...
{>>Seems to me we don't need this as we have SOLO at the bottom of the page... @kmarjanovic<<}
...
To help you structure your writing, see the following video on [*Reflective writing*](https://www.youtube.com/watch?v=SntBj0FIApw){target="_blank"} <!-- Auto title, auto embed--> 
...
## Course Learning Evaluation {.unnumbered}
