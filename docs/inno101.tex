...
\emph{Step 2: Social Media Search:}
...
\emph{Step 4: Apply the Elements}
...
\emph{Step 4: Define digital citizenship}
...
\emph{Step 4: Share Your Insights!}
Share a reflection on this activiy by posting either in your blog or on the Discourse forum.

For example:

I didn't realize the is part of digital citizenship because \ldots{}\\
is not particularly relevant for tertiary learners because \ldots{}\\
is particularly relevant for tertiary learners because \ldots{}
\end{reflect}
...
\subsection*{Online Communities}\label{online-communities}}
\addcontentsline{toc}{subsection}{Online Communities}
...
\hypertarget{activity-online-vs.-real-communities}{%
\subsection*{Activity: Online vs.~``Real Communities''}\label{activity-online-vs.-real-communities}}
\addcontentsline{toc}{subsection}{Activity: Online vs.~``Real Communities''}
...
\tightlist
\item
  Online communities are different because \ldots{}
\item
  Real communities are different because \ldots{}
\item
  Online and real communities are similar because \ldots{}
\end{itemize}
...
Michalk, A. (2013, June 27). \href{https://quiip.com.au/is-there-a-definitive-difference-between-online-and-real-life-community/}{The difference between online \& real life community?}
