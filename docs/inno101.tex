...
\subsection*{Course Technology}\label{course-technology}}
\addcontentsline{toc}{subsection}{Course Technology}
...
\hypertarget{course-annotations}{%
\subsubsection*{Course Annotations}\label{course-annotations}}
\addcontentsline{toc}{subsubsection}{Course Annotations}

\href{https://web.hypothes.is/}{Hypothes.is} is our annotation tool. With hypothes.is you can annotate web pages on the Internet as well as keeping private notes when using the highlight feature.
...
\hypertarget{how-to-annotate-a-web-page}{%
\paragraph*{How to annotate a web-page}\label{how-to-annotate-a-web-page}}
\addcontentsline{toc}{paragraph}{How to annotate a web-page}

Four steps to annotating web pages using hypothes.is:

Step 1: \href{https://hypothes.is/signup}{Create an account} on the Hypothes.is website.
Step 2: Add Hypothes.is to your browser. (\href{https://web.hypothes.is/start/\#}{Install} the add-on for Chrome or bookmarklet for other browsers).
...
Step 4: Highlight the text you want to annotate (see \href{https://www.computerhope.com/issues/ch001669.htm}{how to highlight text} published by computerhope.com), click on the ``Annotate'' button which appears when you highlight the text, type your annotation and click ``Post to Public''.
The following video provides a brief overview of how to post an annotation. Watch \href{https://www.youtube.com/watch?v=BFPYqXubTsE}{Hypothesis Web Annotations}

\hypertarget{resources}{%
\paragraph*{Resources}\label{resources}}
\addcontentsline{toc}{paragraph}{Resources}

Go to the \href{https://web.hypothes.is/start/}{Get Started} page to sign up.
- \href{https://web.hypothes.is/quick-start-guide-for-students/}{Quick Start Guide for Students}
- \href{https://web.hypothes.is/student-resource-guide/}{Student resource guide}
- \href{https://web.hypothes.is/help/annotating-with-groups/}{Annotating as a group} (i.e.~share annotations on a page or pages)
...
\hypertarget{activity-identity-social-media-and-learning}{%
\subsection*{Activity: Identity, Social Media, and Learning}\label{activity-identity-social-media-and-learning}}
\addcontentsline{toc}{subsection}{Activity: Identity, Social Media, and Learning}
...
\tightlist
\item
  \textbf{Read}: Choose from the following articles to
\end{enumerate}

\begin{itemize}
\tightlist
\item
  Using \href{https://www.shu.ac.uk/digital-skills/personal/social-media-for-learning}{Social Media for Learning} from Sheffield Hallam University.
\end{itemize}
...
This is the first rev of Conversation Prism (1.0). 3.0 is Now Available - www.theconversationprism.com flickr photo by The Brian Solis shared under a Creative Commons (BY) license
...
\tightlist
\item
  \textbf{Reflect} on the social media technologies you use for learning and how this impacts on your digital footprint and online identity.
\end{enumerate}
...
\hypertarget{activity-why-engage-online}{%
\subsection*{Activity: Why Engage Online?}\label{activity-why-engage-online}}
\addcontentsline{toc}{subsection}{Activity: Why Engage Online?}
...
\tightlist
\item
  Read \href{https://ts2.space/en/the-potential-of-collaborative-intelligence-for-social-media-and-online-communities/}{The Potential of Collaborative Intelligence for Social Media and Online Communities} by
\end{enumerate}

Watch \href{https://www.youtube.com/watch?v=Acc4zY1sQ0o}{Building More Creative Social Networks}
...
\hypertarget{digital-practices-in-academia-and-the-workplace}{%
\section{Digital Practices in Academia and the Workplace}\label{digital-practices-in-academia-and-the-workplace}}
...
\hypertarget{activity-the-future-of-work-optional}{%
\subsection*{Activity: The Future of Work (Optional)}\label{activity-the-future-of-work-optional}}
\addcontentsline{toc}{subsection}{Activity: The Future of Work (Optional)}

\begin{reflect}
In this short video signpost, \href{http://eduvation.ca/bio/}{Ken Steele} from Eduvation speculates about the future of the labour market and the value of higher education in a digital age.
...
\href{https://www.youtube.com/watch?v=EqSCR3HU4eg}{Using Twitter effectively in education - with Alec Couros}
...
\hypertarget{activity-blog-professional-online-identity-and-digital-citizenship-optional}{%
\subsection*{Activity: Blog: Professional online identity and digital citizenship (Optional)}\label{activity-blog-professional-online-identity-and-digital-citizenship-optional}}
\addcontentsline{toc}{subsection}{Activity: Blog: Professional online identity and digital citizenship (Optional)}
...
\hypertarget{activity-annotation---newspaper-and-music-industry-in-a-digital-age}{%
\subsection*{Activity: Annotation - Newspaper and music industry in a digital age}\label{activity-annotation---newspaper-and-music-industry-in-a-digital-age}}
\addcontentsline{toc}{subsection}{Activity: Annotation - Newspaper and music industry in a digital age}

\begin{reflect}
The readings which follow take a retrospective look at the impact of the Internet on the newspaper and music industries.

Please add or reply to annotations using \href{https://web.hypothes.is/}{Hypothes.is} sharing personal insights and experiences. Remember to tag your posts using the course code: LDRS 101.

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Read \href{https://www.bloomsburycollections.com/monograph-detail?docid=b-9781849666275\&tocid=b-9781849666275-chapter3}{Chapter 3} of Weller, M. (2011). \href{https://www.bloomsburycollections.com/monograph?docid=b-9781849666275}{The Digital Scholar: How Technology is Changing Academic Practice}. Bloomsbury Publishing PLC. (Direct \href{https://via.hypothes.is/https://www.bloomsburycollections.com/monograph-detail?docid=b-9781849666275\&tocid=b-9781849666275-chapter3}{hypothes.is link}.)\\
\item
  Read: \href{https://www.theguardian.com/music/2018/apr/24/weve-got-more-money-swirling-around-how-streaming-saved-the-music-industry}{How streaming saved the music industry}, published by the Guardian. (Direct \href{https://via.hypothes.is/https://www.theguardian.com/music/2018/apr/24/weve-got-more-money-swirling-around-how-streaming-saved-the-music-industry}{hypothes.is link}.)\\
\item
  Read: \href{https://medium.com/international-online-journalism/the-future-of-newspapers-in-the-digital-age-c7ac8a118312}{The future of newspapers in the digital age}, published by Julien Sueres. (Direct \href{https://via.hypothes.is/https://medium.com/international-online-journalism/the-future-of-newspapers-in-the-digital-age-c7ac8a118312}{hypothes.is link}.)
\end{enumerate}
\end{reflect}
...
Examples:
- \href{https://www.timeshighereducation.com/student/advice/how-can-ai-be-used-university-students}{How can AI be used by university students?}- \href{https://mystudylife.com/10-best-ai-tools-to-help-students-learn-faster/}{The 10 Best AI Tools to Help Students Learn Faster})
...
Review TWU's policy on \href{https://www.twu.ca/about-us/policies-guidelines/university-policies/academic-misconduct-fraud}{Academic Misconduct \& Fraud}.
...
Next, watch \href{https://www.youtube.com/watch?v=7Pq-S557XQU}{Humans Need Not Apply}
