...
\addcontentsline{toc}{subsubsection}{Technology Proficency}
...
\addcontentsline{toc}{subsubsection}{Basic Technical Requirements}
...
\addcontentsline{toc}{paragraph}{Internet Access \& Connection}
...
\addcontentsline{toc}{paragraph}{Internet Browsers}
...
\addcontentsline{toc}{paragraph}{Shared Drive, Sharing \& Backup}
...
- {[} {]} OwnCloud{]}(\url{https://trinitywestern.teamdynamix.com/TDClient/1904/Portal/KB/ArticleDet?ID=15681})
...
\addcontentsline{toc}{paragraph}{Other Essential Links}
...
\addcontentsline{toc}{subsubsection}{Course Specific Tech Requirements}
