...
\hypertarget{activity-web-presence-challenge}{%
\subsection*{Activity: Web Presence Challenge}\label{activity-web-presence-challenge}}
\addcontentsline{toc}{subsection}{Activity: Web Presence Challenge}
...
\item
  ...
  \textbar{} \textbf{Persona} \textbar{} \textbf{Primary audience} \textbar{}
  \textbar--------------\textbar------------------------------------\textbar{}
  \textbar{} Personal \textbar{} Friends and family \textbar{}
  \textbar{} Professional \textbar{} Employers and professional network \textbar{}
  \textbar{} Academic \textbar{} Peer learning network \textbar{}
\item
