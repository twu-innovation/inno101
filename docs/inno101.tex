...
\hypertarget{building-a-network-of-ideas}{%
\chapter{Building a Network of Ideas}\label{building-a-network-of-ideas}}
...
\textgreater{}\emph{Reach out to your online community for support, and be sure to share resources and insights.}
...
\hypertarget{building-a-course-blog}{%
\section{Building a Course Blog}\label{building-a-course-blog}}
...
\hypertarget{activity-what-is-a-digital-identity}{%
\subsection*{Activity: What is A Digital Identity?}\label{activity-what-is-a-digital-identity}}
\addcontentsline{toc}{subsection}{Activity: What is A Digital Identity?}
...
For learners, the most important issue of digital identity is \ldots{}\\
For employers, the most important issue of digital identity is \ldots{}\\
For employees, the most important issue of digital identity is \ldots{}
\end{reflect}

\hypertarget{defining-online-identity}{%
\subsubsection*{Defining Online Identity}\label{defining-online-identity}}
\addcontentsline{toc}{subsubsection}{Defining Online Identity}
...
\begin{quote}
\textbf{Internet identity}, also online identity or internet persona is a social identity that an Internet user establishes in online communities and websites. It can also be considered as an actively constructed presentation of oneself. Although some people choose to use their real names online, some Internet users prefer to be anonymous, identifying themselves by means of pseudonyms, which reveal varying amounts of personally identifiable information. An online identity may even be determined by a user's relationship to a certain social group they are a part of online. Some can even be deceptive about their identity (\href{https://en.wikipedia.org/wiki/Online_identity}{Wikipedia}:Online).
\end{quote}

\begin{quote}
A \textbf{digital identity} is information on an entity used by computer systems to represent an external agent. That agent may be a person, organisation, application, or device. ISO/IEC 24760-1 defines identity as ``set of attributes related to an entity'' (\href{https://en.wikipedia.org/wiki/Digital_identity}{Wikipedia}: Online).
\end{quote}

\hypertarget{activity-who-am-i-online}{%
\subsection*{Activity: Who am I Online?}\label{activity-who-am-i-online}}
\addcontentsline{toc}{subsection}{Activity: Who am I Online?}
...
\tightlist
\item
  \href{https://www.internetsociety.org/resources/doc/2011/understanding-online-identity-overview-identity/}{An Overview of Identity}.
\item
  \href{https://link.springer.com/article/10.1007/s40894-016-0025-0}{Who am I Online? Understanding the Meaning of Online Contexts for Identity Development}
\end{itemize}
...
Next, watch the following video, \href{https://www.youtube.com/watch?v=Ro_LlRg8rGg}{Four Reasons to Care About Your Digital Footprint}

Another great (optional) resource to check out is UBC's \href{https://digitaltattoo.ubc.ca/}{Digital Tattoo project}.
\end{reflect}
