...
\textless-- take out \#3 - photo - and replace with mind map instructions. take out self-check quizzes? --\textgreater{}
\end{reflect}
...
\hypertarget{activity-digital-footprint-audit-1}{%
\subsection*{Activity: Digital Footprint Audit}\label{activity-digital-footprint-audit-1}}
\addcontentsline{toc}{subsection}{Activity: Digital Footprint Audit}
