...
Net Neutrality And Creative Freedom (Tim Wu at re:publica 2010) flickr photo by Anna L. Schiller shared under a Creative Commons (BY-NC-ND) license\{target=``\_blank''\}
...
\tightlist
\item
  \href{https://en.wikipedia.org/wiki/Net_neutrality_by_country\#:~:text=source\%20or\%20ownership.-,China,is\%20available\%20to\%20their\%20citizens}{Net neutrality by country}
\end{itemize}
...
\addcontentsline{toc}{subsection}{Online impersonation}
...
\addcontentsline{toc}{subsection}{Activity: Impersonation Case Studies}

\begin{reflect}
\textbf{The Real Jon Ronson}
...
Watch \href{https://www.youtube.com/watch?v=gnGAjiALurI}{Declaring Other People Insane \textbar{} Jon Ronson \textbar{} TEDxMarthasVineyard}
...
It is estimated that that the Internet has about 5.473 billion users \footnote{Reference: Tsvetkova, R. \href{https://www.brandwatch.com/blog/amazing-social-media-statistics-and-facts/}{99 Amazing Social Media Statistics and Facts} Brandwatch}, almost half the population of the world (Smith 2016{[}1{]}). With the growing number of internet and social media users, we are witnessing an increase in antisocial behaviour online.
...
\hypertarget{activity-impersonation-case-studies-1}{%
\subsection*{Activity: Impersonation Case Studies}\label{activity-impersonation-case-studies-1}}
\addcontentsline{toc}{subsection}{Activity: Impersonation Case Studies}
...
\item
  \href{https://theconversation.com/how-empathy-can-make-or-break-a-troll-80680}{March, E. (2017). How empathy can make or break a troll}
\end{itemize}
\end{reflect}
...
\begin{itemize}
\item
  Duggan, M. (2014, October 22). \href{https://www.pewresearch.org/internet/2014/10/22/online-harassment/}{Online Harassment}. Pew Research Center Retrieved July 7, 2017. Pew Research Center. (Note that the report comprises eight pages, so you need to click through to the next page indicators at the bottom of each page of the report.)
\item
  Desilver, D. (2021, January 132). \href{https://www.pewresearch.org/short-reads/2021/01/13/qa-what-weve-learned-about-online-harassment/}{Q\&A: What we've learned about online harassment}
\end{itemize}
...
\addcontentsline{toc}{subsection}{Digital redlining}

\hypertarget{equity-and-inclusion}{%
\subsection*{Equity and inclusion}\label{equity-and-inclusion}}
\addcontentsline{toc}{subsection}{Equity and inclusion}
