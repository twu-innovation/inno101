...
\addcontentsline{toc}{section}{Building a Course Blog}
...
Go to \textbf{create.twu.ca} to sign up for your free WordPress site. Please read all the prompts and instructions carefully!
...
Review and customise your blog settings from the dashboard according to your preferences. Start by \textbf{changing your Site Title} under Settings\textgreater General. You need to hit the ``Save'' button to save your changes. (More information about General Settings here.)
...
Visit the appearance option on your dashboard and \textbf{personalise your blog} by:
