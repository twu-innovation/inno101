...
[Watch: *The Matrix - 'I Know Kung Fu'*](https://www.youtube.com/watch?v=0YhJxJZOWBw){target="_blank"} <!-- Auto title, auto embed--> 
...
[Watch: *Mind Mapping in Obsidian Canvas 🧠 Tutorial*](https://www.youtube.com/watch?v=eHI-Szjpafk){target="_blank"} <!-- Auto title, auto embed--> 
...
- *MIT OpenCourseWare*
- list of topics)
- **Write**: Using Obsidian, record your notes from the lecture. [*Open Culture*](https://www.openculture.com/freeonlinecourses){target="_blank"} (2024). Over 30,000 hours of free audio and video lectures[*Open Yale Courses*](https://oyc.yale.edu/){target="_blank"} (2024). Free and open access to a selection of introductory courses including video lectures from Yale University(2024). Series of video lectures from Harvard University(2024). Series of audio and video lectures from Massachusetts Institute of Technology[*Tedx Talks*](https://www.ted.com/){target="_blank"} (2024). Extensive database of video presentations in the form of short, powerful talks (see also
...
- note taking appsannotate web resourcescollaborative toolsproject management toolsgraphic organizersstudy toolsfocus toolsresearch toolswriting tools**Share**: In Discourse, share some tools that you've used or that you plan to use to help in your studies.
...
Build and customize technology integrated workflows to enhance and enrich your learning journeyPractice evaluative judgment to document your process of learning in complex domains of knowledgeEvaluate digital tools, platforms, and interactions based on ethical principles :::
