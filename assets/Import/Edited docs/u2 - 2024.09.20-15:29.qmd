...
For more tutorials on using Litmaps, search online. For example, the [Litmaps YouTube channel](https://vimeo.com/) has some helpful videos.

Prote: delete video 2.1.1 Activity: Using Litmaps
...
- [*Choosing a Topic: Purdue OWL*](https://owl.purdue.edu/owl/general_writing/common_writing_assignments/research_papers/choosing_a_topic.html?v=_M1-aMCJHFg) (n.d.-b)
- [*Building Your Research Skills*](https://libguides.twu.ca/ResearchSkills) (2024)
...
- **Read**: the [*Google Advanced Search Operators Cheat Sheet*](https://www.webfx.com/blog/seo/google-advanced-search-operators-cheat-sheet/) (n.d.) and try a few searches using the operators. Also see the [[*Google Search Cheatsheet*](https://www.youtube.com/watch?v=sy9PVZAbSAQ)](https://quickref.me/google-search.html){target="_blank"} for a more comprehensive list.
...
Visit the [Google Advanced Search](https://www.google.com/advanced_search?sca_esv=c434643757074884&q=google&udm=14&fbs=AEQNm0Aa4sjWe7Rqy32pFwRj0UkWd8nbOJfsBGGB5IQQO6L3J_86uWOeqwdnV0yaSF-x2jrrv3e_fewYh7LFIpXPaEgNQ1vZHC7aVwStfN-hyt8w92zCKbVGDJiCksR9w0HGHPOIKvu_dt1LEbTnzYX1Nmv20Po-5S6HVMVs0EWB3VOTkws6bJzybdvu6ClADkaDFrfYj209&biw=920&bih=715&dpr=2){target="_blank"} web interface:
...
[Google Scholar](https://scholar.google.ca/){target="_blank"} is a good search engine to find scholarly publications. The downside is that Google Scholar does not distinguish between closed and open resources. However, search results which show a PDF next to the listing will probably provide access to a full text version. [Unpaywall](https://unpaywall.org/){target="_blank"} is a free and legal way to identify authored--uploaded PDFs. There are extensions for the Chrome and Firefox open source browsers. Read the frequently asked questions for more information.
...
- [*Searching in Databases*](https://web.library.uq.edu.au/research-tools-techniques/search-techniques/where-and-how-search/searching-databases?v=ndvLm9MIfKA){target="_blank"} (2012)
- [Directory of Open Access Journals (DOAJ)](https://www.youtube.com/watch?v=ndvLm9MIfKA){target="_blank"} -- see also FAQs
...
- **Watch** the following video on using the [*Directory of Open Access Journals (DOAJ)*](https://www.youtube.com/watch?v=ndvLm9MIfKA){target="_blank"} (2016)

[Watch: *Directory of Open Access Journals (DOAJ)*](https://www.youtube.com/watch?v=ndvLm9MIfKA){target="_blank"} <!-- Auto title, auto embed--> 
...
[Watch: *How Library Stuff Works: How to Evaluate Resources (the CRAAP Test)*](https://www.youtube.com/watch?v=_M1-aMCJHFg){target="_blank"} <!-- Auto title, auto embed--> 
...
- **Read** the following:
- [Is Wikipedia a Trustworthy Academic Resource? Scientists Think So](https://libguides.twu.ca/oer){target="_blank"} published by EdTech Magazine.
- [Reliability of Wikipedia](https://www.youtube.com/@litmaps){target="_blank"} article on Wikipedia.
...
- **Watch:** [*Using Wikipedia for Academic Research*](https://www.youtube.com/watch?v=Cql_yVUYj6A){target="_blank"} (2011)

[Watch: *Using Wikipedia for Academic Research (CLIP)*](https://www.youtube.com/watch?v=Cql_yVUYj6A){target="_blank"} <!-- Auto title, auto embed--> 
...
*Future You* a huge favour and get in this habit now.

Before you explore the next essential tool, watch *[Benefits of Using Citation Management Tools](https://www.youtube.com/watch?v=sy9PVZAbSAQ){target="_blank"}* (n.d.).
...
Go to [zotero.org](https://www.zotero.org/){target="_blank"} and click the red "Download" button, then follow the instructions to install Zotero on your computer. If you want to sign up for free storage (300MB) and backup for your library, you can also do that here.
...
- [Zotfile](https://zotfile.com/){target="_blank"} allows you to find and manage PDFs in your Zotero library
- [Citation Counts Manager](https://github.com/eschnett/zotero-citationcounts){target="_blank"} automatically updates citation counts for items in your library
- [scite.ai](https://doaj.org/#installation){target="_blank"} - provides a breakdown of how references are cited in the literature
...
Go to [twu.ca/library](https://www.twu.ca/academics/library){target="_blank"} and search for transformational servant leadership. On the results page, you might notice that you are prompted to sign in to see certain items. There is a yellow banner at the top of the page with a link to login.
...
> [Watch video](https://vimeo.com/557927481){target="_blank"} <!--Video missing--> 
...
[Watch: *How to Annotate PDFs in Zotero | Highlight, create notes, and capture PDF screenshots*](https://www.youtube.com/watch?v=lGeJCsNHBR4){target="_blank"} <!-- Auto title, auto embed--> 
...
- **Watch** the [video](https://www.youtube.com/watch?v=CGGeMrtyjBI?){target="_blank"} on Zotero and Obsidian integration (2022) and see the features offered when you integrate these tools.

[Watch: *Writing with Zotero and Obsidian*](https://www.youtube.com/watch?v=CGGeMrtyjBI?){target="_blank"} <!-- Auto title, auto embed--> 
...
Prote: add embedded article ([\@Colin Madland](mailto:Colin.Madland@twu.ca){target="_blank"} is there a reason to embed the article here, and not just link to it?)
...
- **Watch**:
- [*How to use OER*](https://www.youtube.com/watch?v=Hkz4q2yuQU8){target="_blank"} (2012), then browse through the categories of OERs by discipline provided. Take some time to find an OER that relates to a topic that interests you.
...
- **Watch**:
- [*A Review of the Effectiveness & Perceptions of Open Educational Resources as Compared to Textbooks*](https://www.youtube.com/watch?v=SX0K0hb_xKE){target="_blank"} (2016)

[Watch: *A Review of the Effectiveness & Perceptions of Open Educational Resources As Compared to Textbooks*](https://www.youtube.com/watch?v=SX0K0hb_xKE){target="_blank"} <!-- Auto title, auto embed--> 

{{< video https://www.youtube-nocookie.com/embed/SX0K0hb_xKE >}}

- **Read**: For more information on OER Advocacy, see the chapter on [How to Advocate on Your Campus](https://opentextbc.ca/studenttoolkit/chapter/step-three-how-to-advocate-on-your-campus/){target="_blank"} in the OER Student Toolkit.
...
- **Annotate**: Next, create an annotated bibliography in Obsidian for two sources---include a journal article and a book chapter from an edited collection of chapters by multiple authors.
