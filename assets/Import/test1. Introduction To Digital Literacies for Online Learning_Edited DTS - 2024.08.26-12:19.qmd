...
- **Watch**: To give you some idea of what life is like at TWU, and why people choose TWU, watch the following video: [*Discover Undergraduate Studies at Trinity Western University*](https://youtu.be/Xlqpgb_3cR4?feature=shared){target="_blank"} (2021).

[Watch: *Discover Undergraduate Studies at Trinity Western University*](https://www.youtube.com/watch?v=Xlqpgb_3cR4){target="_blank"} <!-- Auto title, auto embed--> 
...
- [*Students' Engagement in Asynchronous Online Discussion: The Relationship Between Cognitive Presence, Learner Prominence, and Academic Performance*](https://twu.idm.oclc.org/login?url=https://search.ebscohost.com/login.aspx?direct=true&db=edselp&AN=S1096751619304105&site=eds-live&scope=site){target="_blank"} (2019)
...
- Once you are done, write a two to three sentence summary ***in your own words*** of the article and how it relates to you and your experience.
...
It is ***highly*** recommended[^1] that you begin using a reference manager---we recommend Zotero as it is a free and open source app with all you will ever need to cite properly in any style. We will lead you through some specifics of using Zotero in the next unit of LDRS 101, but if you want to get started, you can [download Zotero](https://www.zotero.org/){target="_blank"} for free.
...
- **Discuss**: Head over to [the Learning Hub](https://twu.discourse.group){target="_blank"} on Discourse and find the
    *Leadership 101* category. Start a conversation about one of the following (or something else relevant):
...
- Work through the **Getting Started** section of the Obsidian help pages starting with [**Create a vault**](https://help.obsidian.md/Getting+started/Create+a+vault){target="_blank"}.
...
- [Click this link to download the vault](https://github.com/twu-innovation/ldrs101-vault/archive/refs/heads/main.zip){target="_blank"}
...
[Alt text: Screenshot, Obsidian extracted files listed]

::: {#fig-image1}

![](assets/test1.%20Introduction%20To%20Digital%20Literacies%20for%20Online%20Learning_Edited%20DTS/image1.png){fig-alt="" .lightbox fig-align="left"}
...
[Alt text: Screenshot, Obsidian, with three icons on far left]

::: {#fig-image2}

![](assets/test1.%20Introduction%20To%20Digital%20Literacies%20for%20Online%20Learning_Edited%20DTS/image2.png){fig-alt="" .lightbox fig-align="left"}
...
- [*Rethinking Learning: The 21st Century Learner*](https://www.youtube.com/watch?v=c0xa98cy-Rw){target="_blank"} (2010)
...
[Watch: *Rethinking Learning: The 21st Century Learner | MacArthur Foundation*](https://www.youtube.com/watch?v=c0xa98cy-Rw){target="_blank"} <!-- Auto title, auto embed--> 
...
[Alt text: Screenshot, Obsidian, today's daily note icon circled]

::: {#fig-image3}

![](assets/test1.%20Introduction%20To%20Digital%20Literacies%20for%20Online%20Learning_Edited%20DTS/image3.png){fig-alt="" .lightbox fig-align="left"}

<!-- Image missing caption and alt text--> 

:::

- Style your text using Markdown codes. [Click here for the basic Markdown syntax (n.d.).](https://help.obsidian.md/Editing+and+formatting/Basic+formatting+syntax){target="_blank"}
...
- Scan the [#diglit](https://twitter.com/i/flow/login?redirect_after_login=%2Fhashtag%2Fdiglit%3Fs%3D03){target="_blank"} hashtag on X (Twitter)---did you find any valuable links to defining digital literacy?
...
- Read [*What is Digital Literacy?*](http://pomo.com.au/blog/digital-literacy/){target="_blank"} (2014) by POMO---is this a reliable source?
...
- **Watch**:
- *[The Essential Elements of Digital Literacies](https://www.youtube.com/watch?v=A8yQPoTcZ78){target="_blank"}* (2012)

[Watch: *The essential elements of digital literacies: Doug Belshaw at TEDxWarwick*](https://www.youtube.com/watch?v=A8yQPoTcZ78){target="_blank"} <!-- Auto title, auto embed--> 

{{< video https://www.youtube-nocookie.com/embed/A8yQPoTcZ78 >}}

- **Read**: Next, read the *[Quick Guide - Developing Students' Digital Literacy](https://digitalcapability.jiscinvolve.org/wp/files/2014/09/JISC_REPORT_Digital_Literacies_280714_PRINT.pdf){target="_blank"}* (n.d.)*.*
...
[Alt text: Schematic of seven elements of digital literacies]

::: {#fig-image4}

![](assets/test1.%20Introduction%20To%20Digital%20Literacies%20for%20Online%20Learning_Edited%20DTS/image4.png){fig-alt="" .lightbox fig-align="left"}

<!-- Image missing caption and alt text--> 

:::

*Note.* From "*Quick Guide - Developing Students' Digital Literacy*," by Jisc Digital Experience Insights, n.d., p. 2, ([https://digitalcapability.jiscinvolve.org/wp/files/2014/09/JISC_REPORT_Digital_Literacies_280714_PRINT.pdf](https://digitalcapability.jiscinvolve.org/wp/files/2014/09/JISC_REPORT_Digital_Literacies_280714_PRINT.pdf){target="_blank"}). [CC BY-NC-ND 2.0 UK](https://creativecommons.org/licenses/by-nc-nd/2.0/uk/){target="_blank"}.
...
- **Watch**:
- [*Digital Literacy and Why it Matters*](https://www.youtube.com/watch?v=p2k3C-iB88w){target="_blank"} (2014)

[Watch: *Digital literacy and why it matters*](https://www.youtube.com/watch?v=p2k3C-iB88w){target="_blank"} <!-- Auto title, auto embed--> 
...
- **Watch**:
- [*Visitors and Residents*](https://www.youtube.com/watch?v=sPOG3iThmRI){target="_blank"} (2014)

[Watch: *Visitors and Residents*](https://www.youtube.com/watch?v=sPOG3iThmRI){target="_blank"} <!-- Auto title, auto embed--> 
...
[Alt text: Example of a Visitor--Resident diagram including many online tools]

::: {#fig-image5}

![](assets/test1.%20Introduction%20To%20Digital%20Literacies%20for%20Online%20Learning_Edited%20DTS/image5.png){fig-alt="" .lightbox fig-align="left"}
...
- **Read:**
- [*Visitors and Residents: A New Typology for Online Engagement*](https://firstmonday.org/ojs/index.php/fm/article/view/3171){target="_blank"} (2011)
...
***Note:*** This diagram can be used to demonstrate your understanding of the course learning outcomes. See the Assessment tab in Moodle for how this activity relates to the assessments in this course*.*
...
[Alt text: Table showing time it takes hackers to brute force a password]

::: {#fig-image6}

![](assets/test1.%20Introduction%20To%20Digital%20Literacies%20for%20Online%20Learning_Edited%20DTS/image6.jpg){fig-alt="" .lightbox fig-align="left"}
...
- **Watch**:
- [*Reflective Writing*](https://www.youtube.com/watch?v=QoI67VeE3ds){target="_blank"} (2014)

[Watch: *Reflective Writing*](https://www.youtube.com/watch?v=QoI67VeE3ds){target="_blank"} <!-- Auto title, auto embed--> 
...
[Alt text: Screenshot showing where to find daily note icon in Obsidian]

::: {#fig-image7}

![](assets/test1.%20Introduction%20To%20Digital%20Literacies%20for%20Online%20Learning_Edited%20DTS/image7.png){fig-alt="" .lightbox fig-align="left"}
...
> ***Note:*** *This journal entry can be used to demonstrate your
> understanding of the course learning outcomes. See the Assessment tab
> in Moodle for how this activity relates to the assessments in this
> course.*
