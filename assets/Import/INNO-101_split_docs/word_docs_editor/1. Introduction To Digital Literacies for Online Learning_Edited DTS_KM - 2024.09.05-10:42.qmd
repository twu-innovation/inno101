...
- **Read**: Take some time to work through The Learner (2022). It begins with a short video and includes activities that you can complete. These are for your reflection.
...
![](assets/1.%20Introduction%20To%20Digital%20Literacies%20for%20Online%20Learning_Edited%20DTS_KM/image2.png){fig-alt="Screenshot, Obsidian, with three icons on far left" .lightbox fig-align="left"}
...
*Note.* From "*Quick Guide - Developing Students' Digital Literacy*," by Jisc Digital Experience Insights, n.d., p. 2, (https://digitalcapability.jiscinvolve.org/wp/files/2014/09/JISC_REPORT_Digital_Literacies_280714_PRINT.pdf). [CC BY-NC-ND 2.0 UK](https://creativecommons.org/licenses/by-nc-nd/2.0/uk/){target="_blank"}.
