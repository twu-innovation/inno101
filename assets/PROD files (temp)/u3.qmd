...
<!--[Watch: *Stop Studying. Start Learning | Justin Sung | TEDxUOA*](https://www.youtube.com/watch?v=TQXMl4GycD0){target="_blank"}

{{< video https://www.youtube-nocookie.com/embed/TQXMl4GycD0 >}}-->
...
![](assets/u3/wikilink.png){fig-alt="Screenshot of how to create a wikilink in Obsidian" .lightbox fig-align="left"}

Screenshot of how to create a wikilink in Obsidian
...
![](assets/u3/wikilink2.png){fig-alt="Screenshot of how to create a wikilink in Obsidian" .lightbox fig-align="left"}
...
![](assets/u3/graph2.png){fig-alt="Screenshot of the graph view in Obsidian" .lightbox fig-align="left"}

Screenshot of the graph view in Obsidian
...
![](assets/u3/graph1.png){fig-alt="Screenshot of the graph view in Obsidian" .lightbox fig-align="left"}
...
![](assets/u3/graph3.png){fig-alt="Screenshot of the graph view in Obsidian" .lightbox fig-align="left"}
...
[watch: The Matrix - 'I Know Kung Fu'](https://www.youtube.com/watch?v=0YhJxJZOWBw){target="_blank"}
...
[Watch: *Mind Mapping in Obsidian Canvas 🧠 Tutorial*](https://www.youtube.com/watch?v=eHI-Szjpafk){target="_blank"}

{{< video https://www.youtube-nocookie.com/embed/eHI-Szjpafk >}}



<!-- notes below from LIDA [https://course.oeru.org/lida101/learning-pathways/learning-in-a-digital-age/reading-and-note-taking/](https://course.oeru.org/lida101/learning-pathways/learning-in-a-digital-age/reading-and-note-taking/){target="_blank"} --> 
...
- [Open culture](https://www.openculture.com/freeonlinecourses){target="_blank"}: Over 30,000 hourse of free audio and video lectures.
...
<!-- give examples? [Coggle: Simple Collaborative Mind Maps & Flow Charts](https://coggle.it/){target="_blank"} [MindMup](https://app.mindmup.com/){target="_blank"} [Canva](https://www.canva.com/){target="_blank"} --> 
