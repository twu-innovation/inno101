...
<a href="/assets/u1/7-digital-literacy-elements.png" class="highslide floatrightm" onclick="return hs.expand(this)" style="max-width:30%">
 <img src="/assets/u1/7-digital-literacy-elements.png" class="img-responsive" alt="filmstrip" title="Click to enlarge">
</a>
