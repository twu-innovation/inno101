...
- download and install Zotero
    - find and add 3 articles related to one of your other courses
- download and install Obsidian
- download and open the course vault in Obsidian
    - activate the plugins that came with the Obsidian vault
    - import data from the three articles you added to Zotero
- create a WordPress site at create.twu.ca

```
<!--
I'm wondering whether having this task first may be a bit overwhelming.  Could we introduce "the digital" - setting the stage for why these tools can benefit them? Do we need to introduce Zotero in this first unit?  We are introducing Obsidian, WP, Discourse, Hypothes.is...maybe save Zotero for Unit 2 on resource management?

I think I'll list the tools on our blueprint in the topics section so we can confirm (https://docs.google.com/document/d/1pXFscdE_6w2Iu9X9icQcJnXIZa2rqdiQokxz-VNjVvA/edit)
