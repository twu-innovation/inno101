...
[Audrey Watters](https://audreywatters.com/) is a scholar and journalist who specialises in educational technology news and analysis. Her work focuses on the interrelationships among politics, pedagogy, business, culture and educational technology. Audrey’s blog [Hack Education](http://hackeducation.com/) is well regarded among international peers.

Read the transcript of a talk Audrey presented at the University of Mary Washington in 2014:

- Watters, A. (2014, November 18). [Men Explain Technology to Me: On Gender, Ed-Tech, and the Refusal to Be Silent](http://hackeducation.com/2014/11/18/gender-and-ed-tech). Hack Education.

Next, watch [Audrey Explains Men Explaining Technology to Her](https://www.youtube.com/watch?v=DMjP_p01foo)
...
[Steph Guthrie](https://stephguthrie.com/) is a gender justice consultant. She is a feminist advocate, organiser and analyst focusing on the intersections of gender, culture and technology to promote more gender-inclusive civic discourse.

Watch [The problem with "Don't Feed the Trolls" | Steph Guthrie | TEDxToronto](https://www.youtube.com/watch?v=_KHEkR5yb9A)
...
DEI stands for Diversity, Equity, and Inclusion. It is a concept and framework often used in the context of workplaces, organizations, and society as a whole to promote fairness, respect, and equal opportunities for all individuals, regardless of their background, identity, or characteristics. Let's break down each component of DEI:

Diversity: Diversity refers to the presence of a wide variety of people with different backgrounds, experiences, identities, and perspectives within a particular group, organization, or community. This can include differences in race, ethnicity, gender, age, sexual orientation, religion, physical and cognitive abilities, socioeconomic status, and more. Embracing diversity means recognizing and valuing these differences as strengths and assets rather than as liabilities.

Equity: Equity is the principle of ensuring that everyone has fair and just opportunities to succeed. It involves identifying and rectifying systemic and structural biases and inequalities that can disproportionately affect certain groups. Achieving equity means providing individuals with the support and resources they need to thrive, even if it requires specific measures to address historical disadvantages.

Inclusion: Inclusion is the practice of actively involving and valuing all individuals, irrespective of their background, in decision-making processes, social activities, and all aspects of life. In an inclusive environment, people feel respected, accepted, and a sense of belonging, and they are encouraged to contribute their unique perspectives and talents.

DEI initiatives are essential because they promote a more fair and just society where everyone has equal access to opportunities, and where differences are respected and celebrated rather than used as a basis for discrimination or exclusion. DEI efforts can encompass policies, programs, and cultural changes within organizations, education systems, and communities to achieve these goals.

Overall, DEI is a multi-faceted approach that seeks to create a more inclusive and equitable world by recognizing and embracing the diversity of human experiences and working to eliminate discrimination and bias. It is an ongoing process that requires commitment, education, and action to create lasting change.
...
How does this relate to diversity and equity?  Let's explore this topic as it relates to how we learn online - but also how we connect to others and serve one another humbly in love (Galatians 5:13))
