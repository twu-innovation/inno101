...
insert - Animation showing location of WordPress help tab - from [https://create.twu.ca/eportfolios/wordpress/](https://create.twu.ca/eportfolios/wordpress/){target="_blank"}<!-- Auto link title --> 
