...
![](assets/u2/library1.png){fig-alt="Screenshot of TWU Library search results for transformational servant leadership" .lightbox fig-align="left"}
...
![](assets/u2/library2.png){fig-alt="Screenshot of TWU Library search results showing export button circled in red on right" .lightbox fig-align="left"}
...
![](assets/u2/library3.png){fig-alt="Screenshot of TWU Library export manager file format options with RIS selected" .lightbox fig-align="left"}
...
<!-- have to adjust hight to percentage--><iframe src="https://wonkhe.com/blogs/intro-to-open-access/" width="100%" height="800"></iframe>
