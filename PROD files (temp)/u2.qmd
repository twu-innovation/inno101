...
One of the quickest ways to get started on a search is to use [Google Scholar (scholar.google.com)](https://scholar.google.com){target="_blank"}, but Google Scholar has some problems in that it will return a huge number of results. Notice that the image below shows over 91,000 results. Far too many for you to sort through.

::: {#fig-googlexsearch1}

![](assets/u2/google-search1.png){fig-alt="Screenshot of the results page of a Google Scholar search for "Transformational servant leadership"" .lightbox fig-align="left"}

Screenshot of the results page of a Google Scholar search for "Transformational servant leadership"
...
![](assets/u2/google-search2.png){fig-alt="Screenshot of the results page of a Google Scholar search for "Transformational servant leadership literature review"" .lightbox fig-align="left"}

Screenshot of the results page of a Google Scholar search for "Transformational servant leadership literature review"
...
![](assets/u2/google-search3.png){fig-alt="Screenshot of an article landing page"" .lightbox fig-align="left"}
...
#### Log in To Litmaps.com {.unnumbered}
...
[Link to LitMaps](https://litmaps.com){target="_blank"}

Paste the DOI.

::: {#fig-litmaps1}

![](assets/u2/litmaps1.png){fig-alt="Screenshot of the Litmaps.com search bar populated with the DOI" .lightbox fig-align="left"}

Screenshot of the Litmaps.com search bar populated with the DOI
...
![](assets/u2/litmaps2.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}

Screenshot of the Litmaps.com seed map
...
![](assets/u2/litmaps3.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/litmaps4.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/litmaps5.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/litmaps6.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/litmaps7.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/litmaps8.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/litmaps9.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/litmaps10.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/litmaps11.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/litmaps12.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/litmaps13.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/litmaps14.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
Prote: Below video is set to private.

:::

{{< video https://www.youtube-nocookie.com/embed/QTIZxc3BaGg >}}
...
3. Visit the [Google Advanced Search](https://www.google.com/advanced_search){target="_blank"} web interface:
...
1. Based on the resources you find, think about whether you need to modify your research question.
...
- [Should university students use Wikipedia?](https://www.theguardian.com/education/2013/may/13/should-university-students-use-wikipedia){target="_blank"} published by theguardian.com. Optional reading annotations: Conduct a search for credible and reliable resources on the topic of the reliability and credibility of Wikipedia articles.

Next, watch [Watch: *Using Wikipedia for Academic Research (CLIP)*](https://www.youtube.com/watch?v=Cql_yVUYj6A){target="_blank"} <!-- Auto title, auto embed--> 
...
<!-- adding content... see [https://course.oeru.org/lida104/learning-pathways/introduction-to-media-literacy/overview/](https://course.oeru.org/lida104/learning-pathways/introduction-to-media-literacy/overview/){target="_blank"} Fact-Checking Online Resources Media, as a form of communication, is never ideologically neutral. Therefore, it is important to develop critical skills to analyse and evaluate media online. Media literacy also encompasses the skills of creating media, so we encourage learners to participate in the optional photo challenge for each pathway in this micro-course. Fact-checking websites: [https://en.wikipedia.org/wiki/List_of_fact-checking_websites](https://en.wikipedia.org/wiki/List_of_fact-checking_websites){target="_blank"} [https://pressbooks.pub/webliteracy/](https://pressbooks.pub/webliteracy/){target="_blank"} [https://pressbooks.pub/webliteracy/chapter/fact-checking-sites/](https://pressbooks.pub/webliteracy/chapter/fact-checking-sites/){target="_blank"} Info on Disinformation: - [https://www.canada.ca/en/campaign/online-disinformation.html?utm_campaign=csec-ctsc-online-disinformation-23-24&utm_medium=sem&utm_source=ggl&utm_content=ad-text-en&utm_term=fake%20news%20sites&adv=2324-472201&id_campaign=20556416294&id_source=156443934711&id_content=674167645142&gclid=CjwKCAiApuCrBhAuEiwA8VJ6JuxREQ1xjjQsKG6LGhaxXIQ_NqHx1HxRdoTVvxMYyqgcVDr5m_7ecBoC4EYQAvD_BwE&gclsrc=aw.ds](https://www.canada.ca/en/campaign/online-disinformation.html?utm_campaign=csec-ctsc-online-disinformation-23-24&utm_medium=sem&utm_source=ggl&utm_content=ad-text-en&utm_term=fake%20news%20sites&adv=2324-472201&id_campaign=20556416294&id_source=156443934711&id_content=674167645142&gclid=CjwKCAiApuCrBhAuEiwA8VJ6JuxREQ1xjjQsKG6LGhaxXIQ_NqHx1HxRdoTVvxMYyqgcVDr5m_7ecBoC4EYQAvD_BwE&gclsrc=aw.ds){target="_blank"} - [https://guides.lib.uw.edu/bothell/news/misinfo](https://guides.lib.uw.edu/bothell/news/misinfo){target="_blank"} Reporting in the mass media Getting into the controversial subjects here... Science Issues [https://www.factcheck.org/scicheck/](https://www.factcheck.org/scicheck/){target="_blank"} Select from these resources that contradict each other. Note - in a basic search it is difficult to find diverse opinions on this issue. Why is that? As you read the articles below, consider the source. What are the credentials of the authors? What biases can you identify? Mainstream Views - [Climate Feedback](https://climatefeedback.org/){target="_blank"} - [Strategies for mitigation of climate change: a review](https://link.springer.com/article/10.1007/s10311-020-01059-w){target="_blank"} - [United Nations: Climate Action](https://www.un.org/en/climatechange){target="_blank"} Alternative Views - [Climate gains are ‘inconvenient truth’ — it’s not all bad news about the environment](https://nypost.com/2022/09/06/theres-plenty-of-good-news-about-the-environment/){target="_blank"} - [Climate Change & the Uncertainty Monster](https://twu.idm.oclc.org/login?url=https://search.ebscohost.com/login.aspx?direct=true&db=edsjsr&AN=edsjsr.26218617&site=eds-live&scope=site){target="_blank"} - [The Predictions Are Wrong | Dr. Judith Curry | EP 329](https://www.youtube.com/watch?v=9Q2YHGIlUDk){target="_blank"} - [Climate Change Hasn’t Set the World on Fire](https://www.wsj.com/articles/climate-change-hasnt-set-the-world-on-fire-global-warming-burn-record-low-713ad3a6){target="_blank"} --> 
...
Before you explore the next essential tool, watch [Watch: *Benefits of Using Citation Management Tools*](https://www.youtube.com/watch?v=sy9PVZAbSAQ){target="_blank"} <!-- Auto title, auto embed--> 
...
![](assets/u2/library1.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/library2.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
![](assets/u2/library3.png){fig-alt="Screenshot of the Litmaps.com seed map" .lightbox fig-align="left"}
...
1. Let's review the basics of Zotero by watching [Watch: *What is Zotero?*](https://www.youtube.com/watch?v=5xClqW2Jv04){target="_blank"} <!-- Auto title, auto embed--> 

{{< video https://www.youtube-nocookie.com/embed/5xClqW2Jv04 >}}

1. Now, let's start using it! Go to the LitMaps, TWU Library or Google Scholar and find articles that interest you.
2. Populate your library with the following resources to support a research topic that interests you.
...
1. If you want to take the next step, let's make your tools work together! Watch the video [Zotero Obsidian Integration](https://www.youtube.com/watch?v=CGGeMrtyjBI){target="_blank"} and see the features offered when you integrate these tools.

{{< video https://www.youtube-nocookie.com/embed/CGGeMrtyjBI >}}

1. Finally, reflect on your use of this tool. In Obsidian, add a journal entry about your learning process and how you might use Zotero or another citation management tool in your studies.
...
[Open Access Explained](https://vimeo.com/557927481){target="_blank"} from [OER Foundation](https://vimeo.com/user17299535){target="_blank"} on [Vimeo](https://vimeo.com){target="_blank"}.
...
### The 5 R's of Openness {.unnumbered}
