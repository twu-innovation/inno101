...
-   View the resources on social learning and consider how learning in community could support your goals.
-   Examine the Career Ready Framework from TWU's Centre for Calling and Career Development
-   Watch the video on the future of work and share your views with your peers.
-   Discuss the impact of digital technology on business.
-   Explore AI tools for university students and view the resources on AI and plagiarism.
-   Discuss the impact of automation and AI in the workplace, as well as the ethical implications of using AI.
-   Select a topic focusing on societal issues on the internet to investigate and publish an editorial on your blog.
...
-   Delete in Zotero too?
-->
```

-   Read [Social Learning in Online Environments](https://openpress.usask.ca/humanmooc/chapter/social-learning-in-online-environments/){target="_blank"} (n.d.) on how we learn in community.
-   Read [Social Learning vs. Community Based Learning: What’s the Difference?](https://www.corporatelearningnetwork.com/learning-design/articles/social-learning-vs-community-based-learning-whats-the-difference) {target="\_blank"} (2022) from a corporate HR Learning and Development perspective.

At TWU and in your workplace you may be asked to participate in various group activities, such as group work, partner projects, team presentations, and so on. What are the benefits of working with others?

Consider the following questions:

-   How have you experienced social or community learning in your educational or professional experiences?
-   How did it help or hinder your learning, productivity, creativity, etc.?
-   What are your goals for sharing your learning at TWU and beyond?

Share your thoughts by posting a comment on Discourse, for example: "Sharing learning is valuable because ..." "Community learning in the workplace is valuable because ..."
:::

### Activity: Preparing for the Future

:::: learning-activity
TWU has a [Centre for Calling & Career Development](https://www.twu.ca/academics/academic-professional-support/centre-calling-career-development){target="_blank"} that aims to equip students for their future careers. Have a look at their Career Ready Framework in the figure below and look specifically for the competencies related to social learning and digital skills? Be sure to click on the image and zoom in to read the details.
...
As LDRS 101 aims to prepare you for the technology skills that are needed in this digital age, we also want to encourage you to develop personal and professional learning networks to discover and share knowledge, collaborate with others, and become engaged digital global citizens.

Consider the following questions:

-   What skills and competencies will benefit you in your career?
...
Below we'll briefly explore technology and change, artificial intelligence, and jobs and automation. There are several other topics related to digital practices in the workplace you may choose to explore. As you engage with the learning activities, consider how your participation can demonstrate your understanding and proficiency of our course learning outcomes (applying technology-integrated workflows, using digital literacy skills, documenting your learning process, evaluating tools, and sharing your knowledge.

### Activity: The Future of Work

::: learning-activity
Watch [What is the Future of Work?](https://www.youtube.com/watch?v=EuDnSqAo784){target="_blank"} (2022) from the World Economic Forum

{{< video https://www.youtube-nocookie.com/embed/EuDnSqAo784 >}}

```{=html}
<!-- deleted 
In the following video, [Ken Steele](http://eduvation.ca/bio/){target="_blank"} What is the Future of Work? | World Economic Forum
speculates about the future of the labour market and the value of higher education in a digital age.
...
-   [The Future of Newspapers in the Digital Age: Embracing the Change!](https://medium.com/@kumarpriyanshu025/the-future-of-newspapers-in-the-digital-age-embracing-the-change-fe835bd8d52f){target="_blank"} (2023) Add or reply to annotations using [Hypothes.is](https://web.hypothes.is/){target="_blank"}, sharing personal insights and experiences. Remember to tag your posts using the course code: LDRS101.
:::
...
*Tip: View the resource in full screen by clicking on the three dots on the bottom right, and then selecting the full screen arrows.*
...
-   Optional resource: [ChatGPT and Artificial Intelligence in Higher Education: Quick Start Guide](https://www.iesalc.unesco.org/wp-content/uploads/2023/04/ChatGPT-and-Artificial-Intelligence-in-higher-education-Quick-Start-guide_EN_FINAL.pdf){target="_blank"}. (2023)
:::::
...
-   Watch [AI Automation And The Future Of The Workforce](https://www.youtube.com/watch?v=NBLeWpOqhAo){target="_blank"} (2022)

{{< video https://www.youtube-nocookie.com/embed/NBLeWpOqhAo >}}
...
-   Read [OpenAI Used Kenyan Workers on Less Than \$2 Per Hour to Make ChatGPT Less Toxic](https://time.com/6247678/openai-chatgpt-kenya-workers/){target="_blank"} (2023) and [Inside Facebook's African Sweatshop](https://time.com/6147458/facebook-africa-content-moderation-employee-treatment/){target="_blank"} (2022)
...
***Choose one*** societal issue or antisocial behaviour associated with the internet that you would like to investigate further. You may wish to browse the other sections, but each topic can be time-consuming, so be sure to map out your time so you can complete your learning goals.

Your task will be to publish an editorial on your chosen topic in your course blog. You will base your focus on your reading of open access resources you find online. Your blog post will also help you build your online identity.
...
<!-- prote - the H5P is missing. note this may be a glitch in the Quarto\>Word\>editor\>Quarto workflow. @chloecwh let's discuss! -->
...
In the next activity you will be asked to search online for credible sources on how website tracking works, how your data is used, and how you can protect yourself online.

```{=html}
<!-- deleting accordions & info
...
-   [Get Cyber Safe](https://www.getcybersafe.gc.ca/en) {target="\_blank"} (2024) is a national public awareness campaign created to inform Canadians about cyber security and the simple steps they can take to protect themselves online.
-   [Protecting your information and data when using applications- ITSAP.40.200](https://www.cyber.gc.ca/en/protecting-your-information-and-data-when-using-applications-itsap40200) {target="\_blank"} (2023) from [Canadian Centre for Cyber Security](https://www.cyber.gc.ca/en)
-   [*The Real Cost of the 'Free' Internet*](http://mediashift.org/2018/01/real-cost-free-internet/){target="_blank"} (2018) - [*Don't Be Evil: Should we use Google in Schools?*](https://link.springer.com/article/10.1007/s11528-021-00599-4){target="_blank"} (2021)
...
::: learning-activity
-   Visit the profile page of following X (formerly Twitter) accounts:
...
::: learning-activity
-   Take the [Spot the Troll](https://spotthetroll.org/){target="_blank"} quiz (n.d.), which uses images of real social media content. How did you do? Did some of the profiles surprise you? Have you encountered these types of profiles on social media?
-   As you read the following, pay particular attention to strategies for dealing with trolling behaviour.
...
-   Watch [The Secret Confessions of an Internet Troll](https://www.youtube.com/watch?v=5BQp3V_34BE){target="_blank"} (2016)

{{< video https://www.youtube-nocookie.com/embed/5BQp3V_34BE >}}

-   Read the following articles and add or reply to annotations on Hypothes.is, focusing on how the research relates to your own online experience. Remember to tag your posts using the course code: LDRS101.
...
### Activity: Social Media Policies and Practices

::: learning-activity
View the the following policy resources on online harassment from X and Meta (Facebook, Instagram, Messenger and Threads).

-   [*Meta Community Standards*](https://transparency.meta.com/policies/community-standards/){target="_blank"} (n.d.)
-   [*About Online Abuse*](https://help.twitter.com/en/safety-and-security/cyber-bullying-and-online-abuse){target="_blank"} (n.d.)

Search online for current events related to social media platforms and harassment. What are the companies doing to prevent bullying, child exploitation, hate speech, etc.?
:::
...
-   Jot down your thoughts in your Reflective Journal (Obsidian).

-   Finally, read the following article which summarizes a number of psychological disorders related to our use of digital technology:
...
[*Net Neutrality Explained*](https://www.youtube.com/watch?v=p90McT24Z6w){target="_blank"} (2015)<!-- Auto title, auto embed-->

{{< video https://www.youtube-nocookie.com/embed/p90McT24Z6w >}}

[*Internet Citizens: Defend Net Neutrality*](https://www.youtube.com/watch?v=wtt2aSV8wdw){target="_blank"} (2014b) <!-- Auto title, auto embed-->
...
::: learning-activity
Explore the issue of net neutrality. Here are some sample resources, but please search for additional resources that interest you. Seek out different perspectives on the topic to inform your views. First, have a look at a summary of [*Net Neutrality by Country*](https://en.wikipedia.org/wiki/Net_neutrality_by_country#:~:text=source%20or%20ownership.-,China,is%20available%20to%20their%20citizens){target="_blank"} (2024).
...
Share your thoughts on net neutrality by posting a comment on Discourse. For example: - Net neutrality is important because ... - Net neutrality can/can't coexist with Internet.org because ... - Free basics is a good thing because ... - Free basics is problematic because ...
...
-   Limited internet access or affordable data plans
-   Discriminatory algorithms
-   Targeted advertising and privacy concerns
-   Educational disparities due to inadequate access to technology and online resources
-   Healthcare access (e.g. telehealth services)
...
-   Choose from the following resources to explore:
...
Many in higher education uphold the value of equality, treating each student identically. Others advocate for equity, which "takes into consideration a person's unique circumstances, adjusting treatment accordingly so that the end result is equal (McKinsey & Company, 2022, Equity section)." But what does it mean for the “end result” to be equal? Does it suggest equal opportunity for access and success in academia? Or is it about ensuring all students achieve the same academic outcomes, such as receiving the same grades?

This example highlights one of the complex issues in the DEI debate. In the next activity, we’ll explore various perspectives on DEI.
...
::: learning-activity
In this activity you are asked to publish an editorial (400--600 words) on your blog on a societal issue or antisocial behaviour associated with the internet. Your editorial must:
...
Post your editorial on your blog and be sure to share with your peers.
:::
