...
1. Go to [obsidian.md](https://obsidian.md){target="_blank"} and click 'Get Obsidian for...'. The site will detect which system you are using and will give you the correct link. I use macOS, so the button below is customized for my system.

![Screenshot ot obsidian.md](digital-literacy/obsidian.png)

2. Follow the instructions to install Obsidian on your computer.
