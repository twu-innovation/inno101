...
- **Write**: Add to your Reflective Journal your thoughts and experience on using tags. What were your struggles or "ah-ha" moments? What questions do you have? Remember to reach out for support on the [Learning Hub](https://twu.discourse.group/){target="_blank"} in Discourse.
...
- **Read** the following articles and take notes in Obsidian. Try using Markdown to format your text.
  ...
  - [*Using Markdown in Obsidian*](https://help.obsidian.md/Editing+and+formatting/Basic+formatting+syntax){target="_blank"} (n.d.)
